...
namespace lab8A {
    ...
    public partial class ProductDBDataSet : global::System.Data.DataSet {
        ...
        public partial class productsDataTable : global::System.Data.TypedTableBase<productsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public productsRow AddproductsRow(int ProductID, decimal UnitPrice, string ProductName) {
            ...
            private void InitClass() {
                ...
                this.columnProductName.MaxLength = 80;
            }
...
namespace lab8A.ProductDBDataSetTableAdapters {
    ...
    public partial class productsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[products] WHERE (([ProductID] = @Original_ProductID) AND ([Uni" +
                "tPrice] = @Original_UnitPrice) AND ([ProductName] = @Original_ProductName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[products] ([ProductID], [UnitPrice], [ProductName]) VALUES (@P" +
                "roductID, @UnitPrice, @ProductName);\r\nSELECT ProductID, UnitPrice, ProductName F" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[products] SET [ProductID] = @ProductID, [UnitPrice] = @UnitPrice, [ProductName] = @ProductName WHERE (([ProductID] = @Original_ProductID) AND ([UnitPrice] = @Original_UnitPrice) AND ([ProductName] = @Original_ProductName));
SELECT ProductID, UnitPrice, ProductName FROM products WHERE (ProductID = @ProductID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::lab8A.Properties.Settings.Default.ProductDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductID, UnitPrice, ProductName FROM dbo.products";
        ...
        public virtual int Delete(int Original_ProductID, decimal Original_UnitPrice, string Original_ProductName) {
        ...
        public virtual int Insert(int ProductID, decimal UnitPrice, string ProductName) {
        ...
        public virtual int Update(int ProductID, decimal UnitPrice, string ProductName, int Original_ProductID, decimal Original_UnitPrice, string Original_ProductName) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(decimal UnitPrice, string ProductName, int Original_ProductID, decimal Original_UnitPrice, string Original_ProductName) {
            return this.Update(Original_ProductID, UnitPrice, ProductName, Original_ProductID, Original_UnitPrice, Original_ProductName);
        }
    }
