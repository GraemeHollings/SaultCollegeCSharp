...
namespace Lab3C_2
{
        ...
        
    {
        ...
        public string GetClassList<T>(T Teacher)
            //T is assigned to be a teacher object
            where T  : Teacher
            ...
            if (!(School is School))
                ...
                //outputting the teacher name and the course code.
                return (School as School).Name + " enrollment: " + ret + "\n" 
                        + "Teacher:" + (Teacher as Teacher).Name + "\n" + "Course Code: " + (Teacher as Teacher).code;
            }
